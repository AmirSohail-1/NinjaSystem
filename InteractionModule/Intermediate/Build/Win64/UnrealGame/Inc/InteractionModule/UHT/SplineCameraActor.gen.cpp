...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SplineCameraActor_eventIsAtEndOfSpline_Parms), &Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASplineCameraActor, nullptr, "IsAtEndOfSpline", nullptr, nullptr, Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::PropPointers), sizeof(SplineCameraActor_eventIsAtEndOfSpline_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C080C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline_Statics::PropPointers) < 2048);
	static_assert(sizeof(SplineCameraActor_eventIsAtEndOfSpline_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASplineCameraActor_SetCameraAsViewTarget_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASplineCameraActor, nullptr, "SetCameraAsViewTarget", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASplineCameraActor_SetCameraAsViewTarget_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASplineCameraActor_SetCameraAsViewTarget_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ASplineCameraActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASplineCameraActor_IsAtEndOfSpline, "IsAtEndOfSpline" }, // 4185681065
		{ &Z_Construct_UFunction_ASplineCameraActor_SetCameraAsViewTarget, "SetCameraAsViewTarget" }, // 1117308730
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_NextLevelName = { "NextLevelName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASplineCameraActor, NextLevelName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_NextLevelName_MetaData), Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_NextLevelName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_InitialDelay = { "InitialDelay", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASplineCameraActor, InitialDelay), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_InitialDelay_MetaData), Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_InitialDelay_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_SplineComponent = { "SplineComponent", nullptr, (EPropertyFlags)0x0040000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASplineCameraActor, SplineComponent), Z_Construct_UClass_USplineComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_SplineComponent_MetaData), Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_SplineComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_CameraComponent = { "CameraComponent", nullptr, (EPropertyFlags)0x00400000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASplineCameraActor, CameraComponent), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_CameraComponent_MetaData), Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_CameraComponent_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_CameraSpeed = { "CameraSpeed", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASplineCameraActor, CameraSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_CameraSpeed_MetaData), Z_Construct_UClass_ASplineCameraActor_Statics::NewProp_CameraSpeed_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ASplineCameraActor_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::Class_MetaDataParams), Z_Construct_UClass_ASplineCameraActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASplineCameraActor_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_SplineCameraActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_SplineCameraActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASplineCameraActor, ASplineCameraActor::StaticClass, TEXT("ASplineCameraActor"), &Z_Registration_Info_UClass_ASplineCameraActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASplineCameraActor), 4227834958U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_SplineCameraActor_h_4259950990(TEXT("/Script/InteractionModule"),
		Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_SplineCameraActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_SplineCameraActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
