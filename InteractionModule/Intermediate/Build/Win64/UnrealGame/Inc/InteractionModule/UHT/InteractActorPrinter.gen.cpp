...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InteractActorPrinter_eventGetNumPlayerPawns_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::NewProp_WorldContextObject_MetaData), Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::NewProp_WorldContextObject_MetaData) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InteractActorPrinter_eventGetNumPlayerPawns_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AInteractActorPrinter, nullptr, "GetNumPlayerPawns", nullptr, nullptr, Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::PropPointers), sizeof(Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::InteractActorPrinter_eventGetNumPlayerPawns_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::Function_MetaDataParams), Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns_Statics::InteractActorPrinter_eventGetNumPlayerPawns_Parms) < MAX_uint16);
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::NewProp_Message = { "Message", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InteractActorPrinter_eventPrintMessageWithColor_Parms, Message), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::NewProp_Message_MetaData), Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::NewProp_Message_MetaData) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::NewProp_TextColor = { "TextColor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(InteractActorPrinter_eventPrintMessageWithColor_Parms, TextColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(0, nullptr) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AInteractActorPrinter, nullptr, "PrintMessageWithColor", nullptr, nullptr, Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::PropPointers), sizeof(Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::InteractActorPrinter_eventPrintMessageWithColor_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::Function_MetaDataParams), Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor_Statics::InteractActorPrinter_eventPrintMessageWithColor_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AInteractActorPrinter_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_AInteractActorPrinter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AInteractActorPrinter_GetNumPlayerPawns, "GetNumPlayerPawns" }, // 3687860248
		{ &Z_Construct_UFunction_AInteractActorPrinter_PrintMessageWithColor, "PrintMessageWithColor" }, // 1553702903
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AInteractActorPrinter_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AInteractActorPrinter_Statics::NewProp_WaveAudio = { "WaveAudio", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AInteractActorPrinter, WaveAudio), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AInteractActorPrinter_Statics::NewProp_WaveAudio_MetaData), Z_Construct_UClass_AInteractActorPrinter_Statics::NewProp_WaveAudio_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AInteractActorPrinter_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AInteractActorPrinter_Statics::Class_MetaDataParams), Z_Construct_UClass_AInteractActorPrinter_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AInteractActorPrinter_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_InteractActorPrinter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_InteractActorPrinter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AInteractActorPrinter, AInteractActorPrinter::StaticClass, TEXT("AInteractActorPrinter"), &Z_Registration_Info_UClass_AInteractActorPrinter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AInteractActorPrinter), 2024919833U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_InteractActorPrinter_h_3822053669(TEXT("/Script/InteractionModule"),
		Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_InteractActorPrinter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_InteractActorPrinter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
