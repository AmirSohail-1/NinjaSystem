...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_MovementSpeed = { "MovementSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACameraHorizontalMovementActor, MovementSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_MovementSpeed_MetaData), Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_MovementSpeed_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_LeftLimit = { "LeftLimit", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACameraHorizontalMovementActor, LeftLimit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_LeftLimit_MetaData), Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_LeftLimit_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_RightLimit = { "RightLimit", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACameraHorizontalMovementActor, RightLimit), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_RightLimit_MetaData), Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_RightLimit_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_CameraComponent = { "CameraComponent", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACameraHorizontalMovementActor, CameraComponent), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_CameraComponent_MetaData), Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::NewProp_CameraComponent_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::Class_MetaDataParams), Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ACameraHorizontalMovementActor_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_CameraHorizontalMovementActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_CameraHorizontalMovementActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACameraHorizontalMovementActor, ACameraHorizontalMovementActor::StaticClass, TEXT("ACameraHorizontalMovementActor"), &Z_Registration_Info_UClass_ACameraHorizontalMovementActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACameraHorizontalMovementActor), 2768867264U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_CameraHorizontalMovementActor_h_3867183548(TEXT("/Script/InteractionModule"),
		Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_CameraHorizontalMovementActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_CameraHorizontalMovementActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
