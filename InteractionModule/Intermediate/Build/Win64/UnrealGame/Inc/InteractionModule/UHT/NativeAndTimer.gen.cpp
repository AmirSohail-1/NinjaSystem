...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANativeAndTimer_CountdownHasFinished_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANativeAndTimer, nullptr, "CountdownHasFinished", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANativeAndTimer_CountdownHasFinished_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANativeAndTimer_CountdownHasFinished_Statics::Function_MetaDataParams) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANativeAndTimer_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_ANativeAndTimer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ANativeAndTimer_CountdownHasFinished, "CountdownHasFinished" }, // 1803578606
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANativeAndTimer_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ANativeAndTimer_Statics::NewProp_CountdownTime = { "CountdownTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANativeAndTimer, CountdownTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANativeAndTimer_Statics::NewProp_CountdownTime_MetaData), Z_Construct_UClass_ANativeAndTimer_Statics::NewProp_CountdownTime_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ANativeAndTimer_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANativeAndTimer_Statics::Class_MetaDataParams), Z_Construct_UClass_ANativeAndTimer_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ANativeAndTimer_Statics::PropPointers) < 2048);
	...
	struct Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_NativeAndTimer_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_NativeAndTimer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANativeAndTimer, ANativeAndTimer::StaticClass, TEXT("ANativeAndTimer"), &Z_Registration_Info_UClass_ANativeAndTimer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANativeAndTimer), 1605613125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_NativeAndTimer_h_3160284715(TEXT("/Script/InteractionModule"),
		Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_NativeAndTimer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TestCpp_Plugins_InteractionModule_Source_InteractionModule_Public_NativeAndTimer_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
