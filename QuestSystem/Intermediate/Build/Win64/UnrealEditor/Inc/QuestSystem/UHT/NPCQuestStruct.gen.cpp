...
template<> QUESTSYSTEM_API UScriptStruct* StaticStruct<FNPCQuestStruct>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNPCQuestStruct_Statics::NewProp_Quests_Inner = { "Quests", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FQuestTable, METADATA_PARAMS(nullptr, 0) }; // 4046486730
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNPCQuestStruct_Statics::NewProp_Quests = { "Quests", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNPCQuestStruct, Quests), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNPCQuestStruct_Statics::NewProp_Quests_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNPCQuestStruct_Statics::NewProp_Quests_MetaData)) }; // 4046486730
...
template<> QUESTSYSTEM_API UScriptStruct* StaticStruct<FNPCQuestHolder>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNPCQuestHolder_Statics::NewProp_Quests_Inner = { "Quests", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FQuestTable, METADATA_PARAMS(nullptr, 0) }; // 4046486730
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNPCQuestHolder_Statics::NewProp_Quests = { "Quests", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNPCQuestHolder, Quests), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNPCQuestHolder_Statics::NewProp_Quests_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNPCQuestHolder_Statics::NewProp_Quests_MetaData)) }; // 4046486730
	...
	struct Z_CompiledInDeferFile_FID_Users_99026_Unreal_CPP_Ninja_Plugins_QuestSystem_Source_QuestSystem_NPCQuestStruct_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_99026_Unreal_CPP_Ninja_Plugins_QuestSystem_Source_QuestSystem_NPCQuestStruct_h_Statics::ScriptStructInfo[] = {
		{ FNPCQuestStruct::StaticStruct, Z_Construct_UScriptStruct_FNPCQuestStruct_Statics::NewStructOps, TEXT("NPCQuestStruct"), &Z_Registration_Info_UScriptStruct_NPCQuestStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNPCQuestStruct), 57825741U) },
		{ FNPCQuestHolder::StaticStruct, Z_Construct_UScriptStruct_FNPCQuestHolder_Statics::NewStructOps, TEXT("NPCQuestHolder"), &Z_Registration_Info_UScriptStruct_NPCQuestHolder, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNPCQuestHolder), 4118264383U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_99026_Unreal_CPP_Ninja_Plugins_QuestSystem_Source_QuestSystem_NPCQuestStruct_h_490477954(TEXT("/Script/QuestSystem"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_99026_Unreal_CPP_Ninja_Plugins_QuestSystem_Source_QuestSystem_NPCQuestStruct_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_99026_Unreal_CPP_Ninja_Plugins_QuestSystem_Source_QuestSystem_NPCQuestStruct_h_Statics::ScriptStructInfo),
		nullptr, 0);
